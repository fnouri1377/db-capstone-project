...
-- -----------------------------------------------------
-- Table `little_lemon_db`.`Customer_Details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `little_lemon_db`.`Customer_Details` (
...
CREATE TABLE IF NOT EXISTS `little_lemon_db`.`Orders` (
  ...
  CONSTRAINT `fk_Orders_Customer_Details1`
    ...
    REFERENCES `little_lemon_db`.`Customer_Details` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
